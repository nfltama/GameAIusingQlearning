...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        # Obstacle 2
        self.obstacle2 = self.canvas_widget.create_image(1, pixels * 2, anchor='nw', image=self.obstacle6_object)
        # Obstacle 3
        ...
        # Obstacle 5
        self.obstacle5 = self.canvas_widget.create_image(pixels * 8, 6, anchor='nw', image=self.obstacle12_object)
        # Obstacle 6
        ...
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(pixels * 6, pixels * 7, anchor='nw', image=self.obstacle4_object)
        # Obstacle 11
        ...
        # Obstacle 22
        self.obstacle22 = self.canvas_widget.create_image(pixels * 2, pixels * 1, anchor='nw', image=self.obstacle2_object)
